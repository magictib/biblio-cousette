...
type Tab = 'inventory' | 'fitter' | 'projects';
...
/* Bouton-mercerie : cercle avec 4 trous, fil en croix quand actif */
    ...
    <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '32px 20px' }}>
      ...
      <nav className="md:hidden" style={{ marginBottom: '20px' }}>
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: '6px', opacity: 0.35, pointerEvents: 'none',
          }}/>
          {navItems.map((item) => (
            <button
              key={item.id}
      ...
      <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
        ...
        <aside
          ...
          style={{ width: '210px', flexShrink: 0, position: 'sticky', top: '88px' }}
        >
          <p style={{
            color: 'var(--brun-mid)',
            fontSize: '0.67rem',
          ...
          <div style={{ position: 'relative' }}>
            {/* Fil vertical traversant les boutons-mercerie */}
            <div style={{
              position: 'absolute',
              left: '12px',
              top: '12px',
                ...
                >
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      alignItems: 'center',
                      gap: '7px',
                      color: isActive ? 'var(--mauve)' : 'var(--brun-mid)',
                      fontFamily: 'Georgia, serif',
          ...
          {/* Pelote de fil décorative en bas */}
          <div style={{
            marginTop: '12px',
            paddingLeft: '4px',
            opacity: 0.45,
        ...
        {/* ── Contenu principal avec surpiqûre ──────────────────────── */}
